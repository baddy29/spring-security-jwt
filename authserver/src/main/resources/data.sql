...
CREATE TABLE USER (ID INT PRIMARY KEY AUTO_INCREMENT, NAME VARCHAR(20), EMAIL_ID VARCHAR(255) , PASSWORD VARCHAR(1000), UNIQUE KEY NAME (EMAIL_ID));
...
UPDATE USER SET PASSWORD = 'password' where id in(1,2);
